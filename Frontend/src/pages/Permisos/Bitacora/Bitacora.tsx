...
const Bitacora: React.FC = () => {
  const logs = [
    { id: 1, fecha: '20 Oct 2023', hora: '14:22:15', usuario: 'Admin Principal', init: 'AP', accion: 'CREACIÓN DE CITA', mod: 'Citas', color: '#003DA6' },
    { id: 2, fecha: '20 Oct 2023', hora: '14:18:02', usuario: 'Coord. Académica', init: 'CA', accion: 'INICIO DE SESIÓN', mod: 'Sistema', color: '#4A4A4A' },
    { id: 3, fecha: '20 Oct 2023', hora: '13:55:10', usuario: 'Admin Principal', init: 'AP', accion: 'EDICIÓN DE PERFIL', mod: 'Usuarios', color: '#D6A600' },
    { id: 4, fecha: '20 Oct 2023', hora: '12:40:00', usuario: 'Soporte Técnico', init: 'ST', accion: 'PERMISOS', mod: 'Permisos', color: '#EF4444' },
    { id: 5, fecha: '20 Oct 2023', hora: '10:15:33', usuario: 'Admin Principal', init: 'AP', accion: 'CREACIÓN DE CITA', mod: 'Citas', color: '#003DA6' },
  ];
    ...
    <div className="bitacora-page">
      <header className="header-fixed">
        ...
        <div className="user-nav">
          <Bell size={22} className="pointer" />
          <img src="https://i.pravatar.cc/150?u=admin" className="user-avatar" alt="profile" />
        </div>
      </header>
            ...
            <tbody>
              {logs.map(log => (
                <tr key={log.id}>
                  ...
                  <td><span className="badge-status" style={{backgroundColor: `${log.color}10`, color: log.color}}>{log.accion}</span></td>
